...
def is_data_in_file(data):
    ...
    new_data = sys.argv[1]
    return new_data in keys_data[1:]
...
def update_data(filepath, data):
    ...
    if new_data in keys_data[1:]:  # redondance use the func is_data_in_file
        old_total_lines = data_eval[new_data]  # get old total lines for this file
